...
# ROOT_DIR = os.path.abspath("/media/khoi/Data/skymapdev/airbus-ship-detection/Mask_RCNN/")
...
def main_predict(model, image_id, image_path, output_path,
                 aoi_file, mask_file, detection_date, chunk_size=512, padding_size=128):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--aoi', required=True,
                        help='path of aoi file')
    parser.add_argument('--mask', required=True,
                        help='path of land mask file')
